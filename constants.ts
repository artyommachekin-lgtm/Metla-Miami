...
export const SERVICES: Service[] = [
  {
    ...
    fullDescription: `Our Maintenance Clean is engineered for the discerning homeowner who requires a consistently pristine living environment. Designed to keep your home in showroom condition, this service is most effective on a weekly or bi-weekly schedule.
...
We focus on maintaining the baseline of cleanliness and order:`,
  ...
  },
  {
    ...
    fullDescription: `Our Deep Clean is the foundational service for a truly healthy home. Recommended as an initial service for all new clients or as a quarterly refresh, this rigorous detail goes far beyond surface maintenance.

We target the "invisible" layer of dirt—the grime that accumulates on baseboards, the dust clinging to ceiling fans, and the residue on cabinet fronts. We use this service to reset your home's baseline cleanliness, preparing it for effortless maintenance thereafter.`,
    focusPoints: [
      {
  ...
  },
  {
    ...
    fullDescription: `Renovation creates a unique type of mess that standard cleaning cannot handle. "Fine particulate dust" settles into the pores of your new flooring, coats your walls, and hides inside air vents.

Our Post-Construction service is a specialized detail designed to safely extract this dust without scratching your new luxury finishes. We use advanced dust-removal methods and microfiber technology to eliminate the "white haze" left behind by drywall and sanding, turning a construction site into a move-in ready home.`,
    focusPoints: [
      {
  ...
  },
  {
    ...
    fullDescription: `In the competitive Miami short-term rental market, cleanliness is the single biggest factor in your guest ratings. Our Vacation Rental service is not just a cleaning; it is a "hospitality turnover."

We act as your eyes and ears on the ground. Beyond sanitizing the space, we stage the property for maximum visual impact, ensuring that when your guests walk in, they feel they are the very first people to stay there. We help you protect your "Superhost" status with consistent, reliable quality.`,
    focusPoints: [
      {
