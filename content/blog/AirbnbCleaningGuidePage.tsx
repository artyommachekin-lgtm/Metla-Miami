                    ...
                    <div className="max-w-3xl mx-auto prose prose-lg prose-slate">
                        ...
                        <div className="bg-slate-50 p-6 rounded-xl my-8 not-prose">
                            ...
                            <div className="flex flex-wrap gap-2">
                                <Link href="/location/miami-beach" className="inline-flex items-center gap-1 px-3 py-1.5 bg-white border border-slate-200 rounded-full text-sm text-slate-700 hover:border-teal-300 hover:text-teal-600 transition-colors">
                                ...
                                <Link href="/location/sunny-isles-beach" className="inline-flex items-center gap-1 px-3 py-1.5 bg-white border border-slate-200 rounded-full text-sm text-slate-700 hover:border-teal-300 hover:text-teal-600 transition-colors">
