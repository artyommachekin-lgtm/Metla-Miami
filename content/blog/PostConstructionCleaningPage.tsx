                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-3xl mx-auto prose prose-lg prose-slate">
                        ...
                        <div className="bg-gradient-to-r from-orange-500 to-amber-500 text-white p-8 rounded-xl my-10 text-center not-prose">
                            ...
                            <Link
                                href="/service/post-construction-cleaning-miami"
                        ...
                        <div className="bg-slate-50 p-6 rounded-xl my-8 not-prose">
                            ...
                            <div className="flex flex-wrap gap-2">
                                <Link href="/location/miami" className="inline-flex items-center gap-1 px-3 py-1.5 bg-white border border-slate-200 rounded-full text-sm text-slate-700 hover:border-teal-300 hover:text-teal-600 transition-colors">
                                    <MapPin className="w-3 h-3" /> Miami
                                </Link>
                                <Link href="/location/brickell" className="inline-flex items-center gap-1 px-3 py-1.5 bg-white border border-slate-200 rounded-full text-sm text-slate-700 hover:border-teal-300 hover:text-teal-600 transition-colors">
                                    <MapPin className="w-3 h-3" /> Brickell
                                </Link>
                                <Link href="/location/coral-gables" className="inline-flex items-center gap-1 px-3 py-1.5 bg-white border border-slate-200 rounded-full text-sm text-slate-700 hover:border-teal-300 hover:text-teal-600 transition-colors">
