                ...
                <div className="max-w-4xl mx-auto mb-20">
                    <div className="prose prose-lg text-slate-600 max-w-none">
                        <p className="text-2xl font-serif text-slate-900 italic mb-8 border-l-4 border-teal-500 pl-6">
                            &ldquo;We didn&apos;t start as a cleaning company. We started as frustrated clients, just like you.&rdquo;
                        </p>
                        <p className="mb-12">
                            The Metla story began in San Diego, where our founders managed over 70 luxury vacation rental properties. We spent years—and thousands of dollars—hiring local cleaning services, only to be constantly disappointed. We saw corners cut, finishes damaged, and a &ldquo;good enough&rdquo; attitude that simply wasn&apos;t good enough for high-end investments. We realized that no one cleans a property like someone who understands the owner&apos;s perspective.
                        </p>
