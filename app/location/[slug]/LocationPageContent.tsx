...
const LocationPageContent: React.FC<{ slug: string }> = ({ slug }) => {
              ...
              <div className="mb-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="p-5 bg-slate-50 rounded-xl">
                    ...
                    <p className="text-sm text-slate-600">
                      Consistent, reliable service with a <Link href="/policies#satisfaction-guarantee" className="text-teal-600 underline hover:text-teal-700">satisfaction guarantee</Link>. Rated 4.9/5 by local clients.
                    </p>
                  </div>
                </div>
              </div>
