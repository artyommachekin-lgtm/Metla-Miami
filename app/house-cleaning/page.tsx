...
import { SERVICES, LOCATIONS, PHONE_NUMBER } from '@/constants';
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto text-center">
                        <div className="flex items-center justify-center gap-2 mb-6">
                            ...
                            <span className="text-slate-300">4.9/5 Rating &bull; 127+ Reviews</span>
                        </div>
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <p className="text-center text-slate-500 text-sm mt-4">
                            *Prices based on 2-3 bedroom home. Larger homes and special requests may vary.{' '}
                            <Link href="/booking" className="text-teal-600 hover:underline font-medium">Get a personalized quote &rarr;</Link>
                        </p>
                    </div>
                </div>
            </section>
