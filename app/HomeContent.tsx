  ...
  return (
    <div className="bg-slate-50 min-h-screen">
      ...
      <section id="services" className="py-20 bg-slate-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-600 max-w-2xl mx-auto">Specific solutions for complex needs. From luxury condos in Brickell to family estates in Coral Gables.</p>
          </div>
      ...
      <section id="locations" className="py-20 bg-slate-900 text-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-serif font-bold mb-12 text-center">Serving the Gold Coast Corridor</h2>
      ...
      <section className="py-20 bg-slate-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <Link href="/blog/deep-cleaning-guide-miami" className="group bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-all">
              <div className="p-6">
            ...
            <Link href="/blog/move-out-cleaning-checklist" className="group bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-all">
              <div className="p-6">
            ...
            <Link href="/blog/airbnb-turnover-cleaning-guide" className="group bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-all">
              <div className="p-6">
          ...
          <div className="text-center mt-10">
            <Link href="/blog" className="inline-flex items-center text-teal-700 font-bold hover:text-teal-800 transition-colors">
